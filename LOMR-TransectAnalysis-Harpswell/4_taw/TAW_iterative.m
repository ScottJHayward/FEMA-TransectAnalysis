...
diary logfiles/CM-135-1-DIARY.txt  % open a diary file to record calculations
diary on         % begin recording

% FEMA appeal for The Town of Harpswell, Cumberland county, Maine
% TRANSECT ID: CM-135-1
% calculation by SJH, Ransom Consulting, Inc. 21-Feb-2020
...
% CONFIG
%--------------------------------------------------------------------------
fname='inpfiles/CM-135-1sta_ele_include.csv';   % file with station, elevation, include
                                      % third colunm is 0 for excluded points
imgname='logfiles/CM-135-1-runup';                            
SWEL=8.8313;  % 100-yr still water level including wave setup. 
H0=NaN;    % significant wave height at toe of structure 
Tp=NaN;    % peak period, 1/fma, 
T0=Tp/1.1;   
...
plotTitle='Iterative TAW for CM-135-1'
...
file=xlsread('../ADCIRC_returns/CM-135-1XYZSTA_RETURNS.csv');
sta_full=file(:,4);
ele_full=file(:,3);
...
-1.000000e+00
xlswrite('../data/transectdata.xls',Z2,'Sheet1','S19');
xlswrite('../data/transectdata.xls',TAW_ALWAYS_VALID,'Sheet1','U19');
xlswrite('../data/transectdata.xls',gamma_berm,'Sheet1','O19');
clear all
close all
format long g

diary logfiles/CM-151-DIARY.txt  % open a diary file to record calculations
diary on         % begin recording
...
% CONFIG
%--------------------------------------------------------------------------
fname='inpfiles/CM-151sta_ele_include.csv';   % file with station, elevation, include
                                      % third colunm is 0 for excluded points
imgname='logfiles/CM-151-runup';                            
SWEL=8.918;  % 100-yr still water level including wave setup. 
H0=3.4963;    % significant wave height at toe of structure 
Tp=8.7174;    % peak period, 1/fma, 
T0=Tp/1.1;   
...
setupAtToe=-0.026024; 
maxSetup=0.3738;   % only used in case of berm/shallow foreshore weighted average 

plotTitle='Iterative TAW for CM-151'
...
file=xlsread('../ADCIRC_returns/CM-151XYZSTA_RETURNS.csv');
sta_full=file(:,4);
ele_full=file(:,3);
...
-1.000000e+00
xlswrite('../data/transectdata.xls',Z2,'Sheet1','S34');
xlswrite('../data/transectdata.xls',TAW_ALWAYS_VALID,'Sheet1','U34');
xlswrite('../data/transectdata.xls',gamma_berm,'Sheet1','O34');
