...
diary logfiles/YK-120-DIARY.txt  % open a diary file to record calculations
...
file=xlsread('../ADCIRC_returns/YK-120XYZSTA_RETURNS.csv');
sta_full=file(:,4);
ele_full=file(:,3);
...
diary logfiles/YK-121-DIARY.txt  % open a diary file to record calculations
diary on         % begin recording
...
file=xlsread('../ADCIRC_returns/YK-121XYZSTA_RETURNS.csv');
sta_full=file(:,4);
ele_full=file(:,3);
...
diary logfiles/YK-124-DIARY.txt  % open a diary file to record calculations
diary on         % begin recording
...
file=xlsread('../ADCIRC_returns/YK-124XYZSTA_RETURNS.csv');
sta_full=file(:,4);
ele_full=file(:,3);
...
diary logfiles/YK-125-DIARY.txt  % open a diary file to record calculations
diary on         % begin recording
...
% CONFIG
%--------------------------------------------------------------------------
fname='inpfiles/YK-125sta_ele_include.csv';   % file with station, elevation, include
                                      % third colunm is 0 for excluded points
imgname='logfiles/YK-125-runup';                            
SWEL=9.0171;  % 100-yr still water level including wave setup. 
H0=4.989;    % significant wave height at toe of structure 
Tp=10.0643;    % peak period, 1/fma, 
T0=Tp/1.1;   

gamma_berm=0.89619;   % this may get changed automatically below
gamma_rough=0.75;  
gamma_beta=1;  
gamma_perm=1;

setupAtToe=0.044396; 
maxSetup=0.85306;   % only used in case of berm/shallow foreshore weighted average 

plotTitle='Iterative TAW for YK-125'
...
file=xlsread('../ADCIRC_returns/YK-125XYZSTA_RETURNS.csv');
sta_full=file(:,4);
ele_full=file(:,3);
...
diary logfiles/YK-127-DIARY.txt  % open a diary file to record calculations
diary on         % begin recording
...
% CONFIG
%--------------------------------------------------------------------------
fname='inpfiles/YK-127sta_ele_include.csv';   % file with station, elevation, include
                                      % third colunm is 0 for excluded points
imgname='logfiles/YK-127-runup';                            
SWEL=9.2229;  % 100-yr still water level including wave setup. 
H0=4.9818;    % significant wave height at toe of structure 
Tp=10.3469;    % peak period, 1/fma, 
T0=Tp/1.1;   

gamma_berm=0.92289;   % this may get changed automatically below
gamma_rough=1;  
gamma_beta=1;  
gamma_perm=1;

setupAtToe=0.0024902; 
maxSetup=0.93514;   % only used in case of berm/shallow foreshore weighted average 

plotTitle='Iterative TAW for YK-127'
...
file=xlsread('../ADCIRC_returns/YK-127XYZSTA_RETURNS.csv');
sta_full=file(:,4);
ele_full=file(:,3);
