...
diary logfiles/CM-96-1-DIARY.txt  % open a diary file to record calculations
...
file=xlsread('../ADCIRC_returns/CM-96-1XYZSTA_RETURNS.csv');
sta_full=file(:,4);
ele_full=file(:,3);
...
diary logfiles/CM-57-1-DIARY.txt  % open a diary file to record calculations
diary on         % begin recording
...
% CONFIG
%--------------------------------------------------------------------------
fname='inpfiles/CM-57-1sta_ele_include.csv';   % file with station, elevation, include
                                      % third colunm is 0 for excluded points
imgname='logfiles/CM-57-1-runup';                            
SWEL=8.9341;  % 100-yr still water level including wave setup. 
H0=3.4921;    % significant wave height at toe of structure 
Tp=4.6289;    % peak period, 1/fma, 
T0=Tp/1.1;   
...
setupAtToe=-0.002769; 
maxSetup=0.51165;   % only used in case of berm/shallow foreshore weighted average 

plotTitle='Iterative TAW for CM-57-1'
...
file=xlsread('../ADCIRC_returns/CM-57-1XYZSTA_RETURNS.csv');
sta_full=file(:,4);
ele_full=file(:,3);
...
diary logfiles/CM-54-DIARY.txt  % open a diary file to record calculations
diary on         % begin recording
...
% CONFIG
%--------------------------------------------------------------------------
fname='inpfiles/CM-54sta_ele_include.csv';   % file with station, elevation, include
                                      % third colunm is 0 for excluded points
imgname='logfiles/CM-54-runup';                            
SWEL=8.9872;  % 100-yr still water level including wave setup. 
H0=9.2146;    % significant wave height at toe of structure 
Tp=13.8824;    % peak period, 1/fma, 
T0=Tp/1.1;   
...
setupAtToe=0.22246; 
maxSetup=2.2367;   % only used in case of berm/shallow foreshore weighted average 

plotTitle='Iterative TAW for CM-54'
...
file=xlsread('../ADCIRC_returns/CM-54XYZSTA_RETURNS.csv');
sta_full=file(:,4);
ele_full=file(:,3);
...
diary logfiles/CM-53-1-DIARY.txt  % open a diary file to record calculations
diary on         % begin recording
...
% CONFIG
%--------------------------------------------------------------------------
fname='inpfiles/CM-53-1sta_ele_include.csv';   % file with station, elevation, include
                                      % third colunm is 0 for excluded points
imgname='logfiles/CM-53-1-runup';                            
SWEL=9.0727;  % 100-yr still water level including wave setup. 
H0=1.7049;    % significant wave height at toe of structure 
Tp=8.0957;    % peak period, 1/fma, 
T0=Tp/1.1;   
...
setupAtToe=-0.0015879; 
maxSetup=0.3469;   % only used in case of berm/shallow foreshore weighted average 

plotTitle='Iterative TAW for CM-53-1'
...
file=xlsread('../ADCIRC_returns/CM-53-1XYZSTA_RETURNS.csv');
sta_full=file(:,4);
ele_full=file(:,3);
